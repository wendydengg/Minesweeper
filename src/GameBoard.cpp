...
// GameBoard::GameBoard() : GameBoard(Difficulty::Easy) {
// }
...
// void GameBoard::initializeBoard(Difficulty difficulty) {
//     cells.clear();
//     click = false;
//     over = 0;
...
//     for (unsigned char x = 0; x < boardSize - 1; ++x) {
//         for (unsigned char y = 0; y < boardSize - 1; ++y) {
//             cells.push_back(Cell<unsigned char>(x, y));
//         }
//     }
// }
...
// void GameBoard::restart() {
// 	initializeBoard(Difficulty::Easy);
// 	if (0 != over) {
// 		click = 0;
// 		over = 0;
// 		for (Cell<unsigned char>& cell : cells) {
